...
@section('content')
    ...
    <div x-data="{ view: 'rent' }" class="space-y-4">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            <div class="inline-flex items-center bg-gray-100 rounded-full p-1 gap-1">
                <button
                    ...
                    class="relative px-3 sm:px-6 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-semibold transition-all duration-300 ease-in-out flex items-center gap-1.5 sm:gap-2"
                >
        ...
        <div x-show="view === 'utility'" x-cloak>
            <livewire:layouts.tenants.tenant-utility-history />
        </div>
    </div>
